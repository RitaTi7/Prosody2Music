...
Per facilitare l'individuazione deterministica dell'accento tonico, è stata implementata una mappa di conversione che 
...
Infine, il sistema si compone anche di uno strumento di normalizzazione del testo. Tramite l'uso di espressioni regolari (ragex) 
...
La scomposizione del testo poetico è basata sull'uso della libreria Python Regex che permette l'implementazione 
...
MIDI standard (.mid), avvalendosi della libreria di Python music21. Il processo si articola in due momenti 
...
\begin{itemize}
      ...
      di music21, la \texttt{quarterLength}, tramite un fattore di scala fisso, dove un impulso equivale a una croma 
      (0.5 quarterLength).
